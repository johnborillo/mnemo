      ...
      <div className="flex-col justify-center pl-15 pr-15">
        ...
        <div className="mt-6">
          ...
          <div className="flex gap-4">
            <button onClick={handleSubmit} className="mt-4 px-4 py-2 bg-[#78A78D] text-white rounded-lg hover:bg-[#2a8e55] duration-300">Save Entry</button>
            <button onClick={clearForm} className="mt-4 px-4 py-2 bg-[#E56B6F] text-white rounded-lg hover:bg-[#DD3C41] duration-300">Clear Entry</button>
          </div>
        </div>
      </div>
    </>
