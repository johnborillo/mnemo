      ...
      {hasLoggedToday ? (
        ...
        <div>
          <div className="flex justify-center">
            ...
            <CustomTooltip
              trigger={<CiCircleInfo className="inline-block mb-3 ml-1 text-gray-500 dark:text-gray-400" />}
          ...
          <div className="mt-6">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div className="flex flex-col">
                <div>
                  <label htmlFor="unique-places" className="mb-1 font-medium text-gray-900 dark:text-white">
              ...
              <div className="flex flex-col">
                <div>
                  <label htmlFor="new-people" className="mb-1 font-medium text-gray-900 dark:text-white">
                    New people
                  </label>
                  <CustomTooltip
                    trigger={<CiCircleInfo className="inline-block mb-3 ml-1 text-gray-500 dark:text-gray-400" />}
              ...
              <div className="flex flex-col">
                <div>
                  <label htmlFor="photo-bursts" className="mb-1 font-medium text-gray-900 dark:text-white">
                    Photo bursts
                  </label>
                  <CustomTooltip
                    trigger={<CiCircleInfo className="inline-block mb-3 ml-1 text-gray-500 dark:text-gray-400" />}
              ...
              <div className="flex flex-col">
                <div>
                  <label htmlFor="task-switches" className="mb-1 font-medium text-gray-900 dark:text-white">
                    Task switches (estimate)
                  </label>
                  <CustomTooltip
                    trigger={<CiCircleInfo className="inline-block mb-3 ml-1 text-gray-500 dark:text-gray-400" />}
              ...
              <div className="flex flex-col">
                <div>
                  <label htmlFor="emotion-mood" className="mb-1 font-medium text-gray-900 dark:text-white">
                    Emotion mood (1-5)
                  </label>
                  <CustomTooltip
                    trigger={<CiCircleInfo className="inline-block mb-3 ml-1 text-gray-500 dark:text-gray-400" />}
            ...
            <div className="flex gap-4">
              <Dialog>
                ...
                <DialogContent>
                  <DialogHeader>
                    <DialogTitle>
                      {isFirstEntry ? "Save your first journal entry?" : "Save this journal entry?"}
                    </DialogTitle>
                    <DialogDescription>
                      <p>
                        {isFirstEntry
                      ...
                      <div className="flex justify-end gap-4 mt-4">
                        <button
                          ...
                          className="px-4 py-2 bg-[#78A78D] text-white rounded-lg hover:bg-[#2a8e55] duration-300"
                        >
                          Confirm
                        </button>
                        <DialogClose>
                          <button
                            className="px-4 py-2 bg-gray-300 text-gray-800 rounded-lg hover:bg-gray-400 duration-300"
                          >
                            Cancel
                          </button></DialogClose>
                      </div>
              ...
              <button
                onClick={clearForm}
                className="mt-2 px-4 py-2 bg-[#E56B6F] text-white rounded-lg hover:bg-[#DD3C41] duration-300"
              >
                Clear Entry
              </button>
            </div>
